    ...
    def build_model(self):
        ...
        with tf.name_scope("loss"):
            ...
            self.loss = .5 * tf.reduce_mean(losses) \
                        + 0.125*(.6 * self.u_loss + .4 * self.u_sen_losses) \
                        + 0.125*(.6 * self.p_loss + .4 * self.p_sen_losses) \
                        + 0.125*(.6 * self.h_loss + .4 * self.h_sen_losses) \
                        + 0.125*(.6 * self.t_loss + .4 * self.t_sen_losses)
