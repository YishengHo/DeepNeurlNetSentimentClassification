...
parser.add_argument("--hidden_size", default=128, type=int, help="hidden_size of rnn")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        for tr_batch in trainbatches:
            ...
            if (current_step > 4000 and current_step < 8000):
                FLAGS.lr = 1e-4
            else:
                FLAGS.lr = 1e-5
            optimizer._lr_t = FLAGS.lr;
            optimizer._lr = FLAGS.lr;
