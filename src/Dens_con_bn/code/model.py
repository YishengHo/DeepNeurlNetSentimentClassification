...
class huapahata(object):
    ...
    def user_attention(self):
        ...
        print("input0.shape:", tf.shape(inputs))
        ...
        inputs2 = self.batch_norm(inputs2);
        print("outputs1.shape:", tf.shape(outputs1))
        print("input1.shape:", tf.shape(inputs2))
        ...
        print("sinput.shape", tf.shape(outputs))
