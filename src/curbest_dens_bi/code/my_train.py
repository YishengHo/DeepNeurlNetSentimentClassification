...
from my_data_helpers import Dataset
...
parser.add_argument("--hidden_size", default=40, type=int, help="hidden_size of rnn")
...
embeddingfile, wordsdict = my_data_helpers.load_embedding(embeddingpath, alldata, FLAGS.embedding_dim)
del alldata
