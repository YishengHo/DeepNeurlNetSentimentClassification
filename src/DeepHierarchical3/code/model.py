    ...
    def build_model(self):
        ...
        with tf.name_scope("loss"):
            ...
            self.loss = .4 * tf.reduce_mean(losses) \
                        + 0.15*(.7 * self.u_loss + .3 * self.u_sen_losses) \
                        + 0.15*(.7 * self.p_loss + .3 * self.p_sen_losses) \
                        + 0.15*(.7 * self.h_loss + .3 * self.h_sen_losses) \
                        + 0.15*(.7 * self.t_loss + .3 * self.t_sen_losses)
